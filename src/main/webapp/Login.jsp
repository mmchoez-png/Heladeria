...
<head>
    ...
    <link rel="stylesheet" href="styles.css/estilo.css" type="text/css"/>
</head>
<body>
    <!-- Encabezado -->
    <header>
        ...
        <nav>
            <ul>
                <li><a href="Presentación.html">Inicio</a></li>
    ...
    <div class="formulario">
        ...
        <p style="margin-top:15px;">¿No tienes cuenta? <a href="Registro.html">Regístrate aquí</a></p>
    </div>
